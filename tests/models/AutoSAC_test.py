...
from deepctr_torch_ext.models import AutoSAC
from ..utils import get_test_data, SAMPLE_SIZE, check_model, get_device


@pytest.mark.parametrize(
    'att_layer_num,dnn_hidden_units,sparse_feature_num',
    [(1, (4,), 2), (0, (4,), 2), (2, (4, 4,), 2), (1, (), 1), (1, (5,), 12)]
)
# @pytest.mark.parametrize(
#     'att_layer_num,dnn_hidden_units,sparse_feature_num',
#     [(1, (5,), 12)]
# )
def test_AutoSAC(att_layer_num, dnn_hidden_units, sparse_feature_num):
    ...
    model = AutoSAC(linear_feature_columns=feature_columns, dnn_feature_columns=feature_columns,
